...
All-in-one NPC pack for Ragnarok Offline — Warper, Buffer, Job Master, and a handful of custom NPCs, all in one mod.

Install
Download the latest release (or clone this repo).
Drop the folder into your Ragnarok Offline mods directory.
Settings → Mods → tick standart-npc → Apply.
What's included
...
Costume Stone Enchanter	Attach class/costume stones for free.	Prontera (164, 169)
Eden Group Gramps	Level-bracketed hunting bounties, 6 brackets from Lv 70 up to 201+, scaling EXP rewards.	Prontera (147, 172)
Overlook Fisherman	Overlook Water Dungeon — 4 floors of bounty quests, ending in a choice of card reward.	Prontera (147, 169)

Full version history: Patch Notes.txt.

Credits
Mondo — pack owner/maintainer.
Lil Art — Safe Refiner, Costume Stone Enchanter, Eden Group Gramps, Overlook Fisherman.
IceGlaive — Gramps/Overlook per-character progress tracking, over-level turn-in fix, live kill notifications, and the 3 extended Gramps level brackets (151–200+), with monster IDs verified live via @mobinfo.
